/*
    Target database:    UAT
    Target instance:    SABRINA
    Generated date:     2022-10-14T10:38:52Z
...
:setvar DefaultFilePrefix "UAT"
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\"
:setvar DefaultBackupPath "C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\"
----====================================================================================================================
...
GO
IF EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('89689a13-afcc-4cc0-a7ba-f1c9abe827a8' AS UNIQUEIDENTIFIER))
  BEGIN
    IF @@TRANCOUNT > 0
      ROLLBACK;
    RAISERROR ('This script "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql" has already been executed within the "$(DatabaseName)" database on this server. Halting deployment.', 16, 127);
    RETURN;
  END
...
***** EXECUTING MIGRATION "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql", ID: {89689a13-afcc-4cc0-a7ba-f1c9abe827a8} *****';

GO


----------------- BEGIN INCREMENTAL MIGRATION: "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql" -------------------
GO
...
GO
------------------ END INCREMENTAL MIGRATION: "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql" --------------------
...
IF @@TRANCOUNT <> 1
  BEGIN
    ...
    SET @ErrorMessage = 'This migration "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql" has left the transaction in an invalid or closed state (@@TRANCOUNT=' + CAST (@@TRANCOUNT AS NVARCHAR (10)) + '). Please ensure exactly 1 transaction is open by the end of the migration script.  Rolling-back any pending transactions.';
...
VALUES                                         (CAST ('89689a13-afcc-4cc0-a7ba-f1c9abe827a8' AS UNIQUEIDENTIFIER), '27C2F26B050CAB9E374BD4716043667CCABF0399E1E2B6AE8A2973A0053A5320', 'Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql', SYSDATETIME(), SYSTEM_USER, 1, NULL, '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);

PRINT '***** FINISHED EXECUTING MIGRATION "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql", ID: {89689a13-afcc-4cc0-a7ba-f1c9abe827a8} *****
';
