...
IF @baselineRequired = 1
  BEGIN
    PRINT '----- baselined: Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql (marked as deployed) -----';
    ...
    VALUES                                         (CAST ('89689a13-afcc-4cc0-a7ba-f1c9abe827a8' AS UNIQUEIDENTIFIER), '27C2F26B050CAB9E374BD4716043667CCABF0399E1E2B6AE8A2973A0053A5320', 'Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql', SYSDATETIME(), SYSTEM_USER, 0, NULL, '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
  END
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('89689a13-afcc-4cc0-a7ba-f1c9abe827a8' AS UNIQUEIDENTIFIER))
  PRINT '
...
BEGIN
  PRINT '----- Skipping "Migrations\1.0.0-Baseline\001_20221014-1015_charl.sql", ID: {89689a13-afcc-4cc0-a7ba-f1c9abe827a8} as it has already been run on this database';
  SET NOEXEC ON;
END
...
GO
EXECUTE ('CREATE TABLE [dbo].[Customer]
(
[Id] [int] NULL,
